...
import { productDetails } from "./productData"; // Assuming this is where the data for pickles will be fetched from
...
const PicklesPage = () => {
  ...
  const [selectedOptions, setSelectedOptions] = useState({}); // Store selected sizes and quantities
              ...
              {filteredProducts.map((product, index) => {
                ...
                return (
                  <div
                    ...
                    style={{ height: "auto" }} // Allow height to be auto on mobile
                  >
                    {/* Product Image */}
                    <div className="w-full sm:w-1/3 mb-4 sm:mb-0 overflow-hidden h-48 sm:h-72">
                      <Image
                        ...
                        width={400}
                        height={320}
                        className="object-cover rounded-lg h-full w-full" // Ensures image fits the container
                      />
                    </div>
